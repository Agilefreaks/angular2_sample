		...
		'base/karma/app': {
			...
			map: Object.keys(window.__karma__.files).
				...
				reduce(function createPathRecords(pathsMapping, appPath) {
					 ...
					 */
					var moduleName = appPath.replace(/^\/base\/karma\/app\//, './').replace(/\.js$/, '');
					pathsMapping[moduleName] = moduleName + '.js?' + window.__karma__.files[appPath]
					return pathsMapping;
				}, {})
		}
	}
...
function onlyAppFiles(filePath) {
	return /^\/base\/karma\/app\/.*\.js$/.test(filePath);
}
